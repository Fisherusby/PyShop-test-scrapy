...
class PhonesSpiders(scrapy.Spider):
    ...
    def __init__(self):
        # create a driver to load dynamic pages
    ...
    def parse(self, response, **kwargs):
        # get all products from products list page
        ...
        for product in all_products:
            ...
            # check products for signs of phones
        ...
        # parse next list page of products
    ...
    def parse_smartphone(self, response):
        ...
        # select all characteristics as dict
        ...
        # some phones list Chrome OS instead of Android
        if phone_os == 'Chrome OS':
            phone_os = 'Android'

        # get os version
        phone__os_value = characteristics.get(f'Версия {phone_os}', 'Unknown')
        # clean os version (get type and first numbers)
        ...
        yield {
            ...
            **characteristics,  # there are all characteristics
        }
